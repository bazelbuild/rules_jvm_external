...
public class IndexJarTest {
  ...
  public void noPackages() throws Exception {
    doTest("hamcrest_core_srcs_for_test/file/hamcrest-core-1.3-sources.jar", sortedSet(), new TreeMap<>());
  }
  ...
  public void invalidCRC() throws Exception {
    doTest(
        "google_api_services_compute_javadoc_for_test/file/google-api-services-compute-v1-rev235-1.25.0-javadoc.jar", sortedSet(), new TreeMap<>());
  }
  ...
  private void doTest(String runfileJar, SortedSet<String> expectedPackages, TreeMap<String, TreeSet<String>> expectedServiceImplementations) throws IOException {
    ...
    IndexJar.PerJarIndexResults perJarIndexResults = IndexJar.index(jar);
  ...
  private TreeMap<String, TreeSet<String>> getLombokServiceImplementations() {
    ...
    lombokServiceImplementations.put("javax.annotation.processing.Processor", sortedSet("lombok.launch.AnnotationProcessorHider$AnnotationProcessor", "lombok.launch.AnnotationProcessorHider$ClaimingProcessor"));
    lombokServiceImplementations.put("lombok.core.LombokApp", sortedSet("lombok.bytecode.PoolConstantsApp", "lombok.bytecode.PostCompilerApp", "lombok.core.Main$LicenseApp", "lombok.core.Main$VersionApp", "lombok.core.PublicApiCreatorApp", "lombok.core.configuration.ConfigurationApp", "lombok.core.runtimeDependencies.CreateLombokRuntimeApp", "lombok.delombok.DelombokApp", "lombok.installer.Installer$CommandLineInstallerApp", "lombok.installer.Installer$CommandLineUninstallerApp", "lombok.installer.Installer$GraphicalInstallerApp"));
    lombokServiceImplementations.put("lombok.core.PostCompilerTransformation", sortedSet("lombok.bytecode.PreventNullAnalysisRemover", "lombok.bytecode.SneakyThrowsRemover"));
    lombokServiceImplementations.put("lombok.core.runtimeDependencies.RuntimeDependencyInfo", sortedSet("lombok.core.handlers.SneakyThrowsAndCleanupDependencyInfo"));
    lombokServiceImplementations.put("lombok.eclipse.EclipseASTVisitor", sortedSet("lombok.eclipse.handlers.HandleFieldDefaults", "lombok.eclipse.handlers.HandleVal"));
    lombokServiceImplementations.put("lombok.eclipse.EclipseAnnotationHandler", sortedSet("lombok.eclipse.handlers.HandleAccessors", "lombok.eclipse.handlers.HandleBuilder", "lombok.eclipse.handlers.HandleBuilderDefault", "lombok.eclipse.handlers.HandleCleanup", "lombok.eclipse.handlers.HandleConstructor$HandleAllArgsConstructor", "lombok.eclipse.handlers.HandleConstructor$HandleNoArgsConstructor", "lombok.eclipse.handlers.HandleConstructor$HandleRequiredArgsConstructor", "lombok.eclipse.handlers.HandleData", "lombok.eclipse.handlers.HandleDelegate", "lombok.eclipse.handlers.HandleEqualsAndHashCode", "lombok.eclipse.handlers.HandleExtensionMethod", "lombok.eclipse.handlers.HandleFieldNameConstants", "lombok.eclipse.handlers.HandleGetter", "lombok.eclipse.handlers.HandleHelper", "lombok.eclipse.handlers.HandleJacksonized", "lombok.eclipse.handlers.HandleLog$HandleCommonsLog", "lombok.eclipse.handlers.HandleLog$HandleCustomLog", "lombok.eclipse.handlers.HandleLog$HandleFloggerLog", "lombok.eclipse.handlers.HandleLog$HandleJBossLog", "lombok.eclipse.handlers.HandleLog$HandleJulLog", "lombok.eclipse.handlers.HandleLog$HandleLog4j2Log", "lombok.eclipse.handlers.HandleLog$HandleLog4jLog", "lombok.eclipse.handlers.HandleLog$HandleSlf4jLog", "lombok.eclipse.handlers.HandleLog$HandleXSlf4jLog", "lombok.eclipse.handlers.HandleNonNull", "lombok.eclipse.handlers.HandlePrintAST", "lombok.eclipse.handlers.HandleSetter", "lombok.eclipse.handlers.HandleSneakyThrows", "lombok.eclipse.handlers.HandleStandardException", "lombok.eclipse.handlers.HandleSuperBuilder", "lombok.eclipse.handlers.HandleSynchronized", "lombok.eclipse.handlers.HandleToString", "lombok.eclipse.handlers.HandleUtilityClass", "lombok.eclipse.handlers.HandleValue", "lombok.eclipse.handlers.HandleWith", "lombok.eclipse.handlers.HandleWithBy"));
    lombokServiceImplementations.put("lombok.eclipse.handlers.EclipseSingularsRecipes$EclipseSingularizer", sortedSet("lombok.eclipse.handlers.singulars.EclipseGuavaMapSingularizer", "lombok.eclipse.handlers.singulars.EclipseGuavaSetListSingularizer", "lombok.eclipse.handlers.singulars.EclipseGuavaTableSingularizer", "lombok.eclipse.handlers.singulars.EclipseJavaUtilListSingularizer", "lombok.eclipse.handlers.singulars.EclipseJavaUtilMapSingularizer", "lombok.eclipse.handlers.singulars.EclipseJavaUtilSetSingularizer"));
